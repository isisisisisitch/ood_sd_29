...
public class Main {
    public static void main(String[] args) {
        ...
        Bank bank = new Bank(bankSystem, 10000);

        Branch branch1 = bank.addBranch("123 Main St", 1000);
        Branch branch2 = bank.addBranch("456 Elm St", 1000);
